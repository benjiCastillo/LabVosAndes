...
$tabla1 = '<table>
                <tr>
                    <td><b>Hora de recolección: </b></td>
                    <td> ' . $prueba->espermograma_pruebas[0]->hora_recoleccion . '</td>
                    <td></td>
                </tr>
                <tr>
                    <td><b>Hora de recepción: </b></td>
                    <td> ' . $prueba->espermograma_pruebas[0]->hora_recepcion . '</td>
                    <td></td>
                </tr>
                <tr>
                    <td><b>Duración de la abstinencia: </b></td>
                    <td> ' . $prueba->espermograma_pruebas[0]->duracion_abstinencia . '</td>
                    <td></td>
                </tr>
                <tr>
                    <br>
                ...
                <tr>
                    ...
                    <td width="165" style="color: rgb(58,137,159)">Opaco Homogéneo</td>
                </tr>
                <tr>
                    <td>Color: </td>
